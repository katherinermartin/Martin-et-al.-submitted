...
allelic_summary_stats <- read.csv("/Users/KatieMartin/Documents/UCF/Research/MHC_species_evo/analysis/MHCII_chr 1_chr 14_combined/allelic_diversity/MHCII_summary_stats_allelic_div_V2.csv")
head(allelic_summary_stats)

indiv_per_spp_MHCII <- ggplot(data =
...
alleles_per_spp_MHCII <- ggplot(data =
                            allelic_summary_stats,
                          aes(x = type,
                              y = alleles_sampled,
                              fill = species)) +
...
alleles_per_spp_MHCII

nucleotide_div_MHCII <- ggplot(data = allelic_summary_stats, aes(x = type,
...
allele_count_mono <- read.csv("MHCII_chr 1_alleles_per_indiv_Cc_Cm_Dc_Lk.csv")
alleles_MHCII_mono <- ggplot(data = allele_count_mono, aes(x = species,
                                           y = allele_count,
                                           fill = species)) +
  geom_boxplot() +
  theme_classic() +
...
allele_count_poly <- read.csv("MHCII_chr 14_alleles_per_indiv_Cc_Cm_Dc_Lk.csv")
alleles_MHCII_poly <- ggplot(data = allele_count_poly, aes(x = species,
                                                           y = allele_count,
                                                           fill = species)) +
  geom_boxplot() +
  theme_classic() +
...
allele_count_MHCII <- read.csv("MHCII_combined_alleles_per_indiv_Cc_Cm_Dc_Lk.csv")
alleles_MHCII <- ggplot(data = allele_count_MHCII, aes(x = type,
                                                           y = allele_count,
                                                           fill = species)) +
  geom_boxplot() +
  theme_classic() +
